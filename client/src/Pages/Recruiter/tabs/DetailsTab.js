        ...
        <div className="border border-gray-200 p-6 rounded-xl bg-gray-400 shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center border-b border-gray-100 pb-4">
                    <div className="w-32 font-medium text-black">Contact</div>
                    <div className="flex items-center">
                        ...
                        <a href={`tel:+91${applicationData.contactInfo}`} className="text-white hover:text-blue-800 hover:underline">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center">
                    <div className="w-32 font-medium text-black">Experience</div>
                    <div className="flex items-center">
                        <svg className="w-4 h-4 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span className="text-white hover:text-blue-800 hover:underline">{applicationData.experience || 'N/A'}</span>
                    </div>
                </div>
