                                ...
                                <table className="w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="divide-y divide-gray-200">
                                        {[
                                            {
                                                jobID: "ai-1",
                                                title: "AI Generated: Senior Software Engineer",
                                                city: "Remote (AI)",
                                                type: "Full-Time",
                                            ...
                                            {
                                                jobID: "ai-2",
                                                title: "AI Generated: Product Manager",
                                                city: "New York (AI)",
                                                type: "Contract",
                                            ...
                                            {
                                                jobID: "ai-3",
                                                title: "AI Generated: UI/UX Designer",
                                                city: "San Francisco (AI)",
                                                type: "Part-Time",
                                                scheduleType: "Flexible",
                                                applicationCount: 5,
                                                hireType: "New",
                                            ...
                                            {
                                                jobID: "ai-4",
                                                title: "AI Generated: DevOps Engineer",
                                                city: "Austin (AI)",
                                                type: "Full-Time",
                                            ...
                                            <tr
                                                key={job.jobID}
                                                className={`group transition-colors duration-150 ${theme === 'dark' ? 'hover:bg-purple-900/20 bg-white/5' : 'hover:bg-purple-50 bg-white'}`}
                                            >
                                                <td className="px-3 md:px-5 lg:px-6 py-5 whitespace-nowrap">
                                                    <div className="text-sm font-medium group-hover:text-purple-600 dark:group-hover:text-purple-400">{job.title}</div>
                                                ...
                                                <td className="px-3 md:px-5 lg:px-6 py-5 whitespace-nowrap">
                                                    <div className="flex items-start">
                                                        <MapPin className="h-4 w-4 text-gray-400 mt-0.5 mr-1 flex-shrink-0" />
                                                        <div className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-900'}`}>{job.city}</div>
                                                    </div>
                                                </td>
                                                <td className="px-3 md:px-5 lg:px-6 py-5 whitespace-nowrap">
                                                    <div className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-300' : 'text-gray-900'}`}>{job.type}</div>
                                                </td>
                                                <td className="px-3 md:px-5 lg:px-6 py-5 whitespace-nowrap">
                                                    <div className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-300' : 'text-gray-900'}`}>{job.scheduleType}</div>
                                                </td>
                                                <td className="px-3 md:px-5 lg:px-6 py-5 whitespace-nowrap text-center">
                                                ...
                                                <td className="px-3 md:px-5 lg:px-6 py-5 whitespace-nowrap text-sm">
                                                    <button
                                                        onClick={() => toastNotify.info("AI Application Details (Mocked)")}
