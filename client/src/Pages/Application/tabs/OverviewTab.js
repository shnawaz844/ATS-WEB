    ...
    return (
        <div className="min-h-screen bg-transparent p-6">
            <div className="max-w-7xl mx-auto flex flex-col justify-center items-center">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden mb-6 max-w-screen-lg w-80 sm:w-full">
                    <div className="flex flex-col lg:flex-row h-auto lg:h-[32vh] min-h-[280px]">
                        {/* Header Section - 30% width on large screens */}
                        <div className="lg:w-[30%] w-full p-5 sm:p-6 lg:p-8 flex flex-col justify-center bg-gradient-to-br from-gray-50 to-white border-b lg:border-b-0 lg:border-r border-gray-200">
                            <div className="text-center lg:text-left">
                                <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start mb-4 gap-4">
                                    <div className="w-14 h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl lg:rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                        ...
                        <div className="lg:w-[70%] w-full p-5 sm:p-6 lg:p-8 flex flex-col">
                            <div className="bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 rounded-xl lg:rounded-2xl shadow-inner flex-1 min-h-[200px] lg:min-h-0 relative overflow-hidden">
                                {/* Background Pattern */}
                                <div className="absolute inset-0 opacity-10">
                                    <div className="absolute top-4 right-4 w-20 h-20 sm:w-24 sm:h-24 bg-white rounded-full"></div>
                                    <div className="absolute bottom-4 left-4 w-16 h-16 sm:w-16 sm:h-16 bg-white rounded-full"></div>
                                </div>
                                ...
                                <div className="relative z-10 p-5 sm:p-6 lg:p-8 h-full flex flex-col">
                                    <div className="flex flex-col sm:flex-row items-start justify-between mb-5 sm:mb-6 gap-4 sm:gap-0">
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center mb-3">
                                                ...
                                                <p className="text-gray-300 text-sm sm:text-sm font-medium uppercase tracking-wider">
                                                    Total Applications
                                                </p>
                                            </div>
                                        ...
                                        <div className="bg-white bg-opacity-20 backdrop-blur-sm p-3 sm:p-3 lg:p-4 rounded-xl lg:rounded-2xl flex-shrink-0 sm:ml-4">
                                            <svg className="w-7 h-7 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="mt-auto">
                                        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-3 sm:p-3 lg:p-4">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200 max-w-screen-lg w-80 sm:w-full">
                    <div className="mb-8">
