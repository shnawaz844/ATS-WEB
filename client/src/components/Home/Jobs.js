                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
                    ...
                    <div className="flex flex-col xs:flex-row gap-2 w-full sm:w-auto">
                        <button
                            ...
                            className="bg-purple-100 text-purple-700 px-3 py-2 rounded-[10px] hover:bg-purple-200 transition-colors text-sm w-full"
                        >
                            View Details
                        </button>
                        <button
                            onClick={ () => handleNavigation( 'apply' ) }
                            className="bg-purple-700 text-white px-4 py-2 rounded-[10px] hover:bg-purple-800 transition-colors w-full"
                        >
                            Apply Now
                        </button>
