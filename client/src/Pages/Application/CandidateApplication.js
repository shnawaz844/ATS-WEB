                            ...
                            <div className='flex flex-col sm:flex-row gap-2 sm:gap-4'>
                                ...
                                <div className="relative rounded-full flex-1 sm:flex-none">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-8 sm:pl-10 pr-4 py-2 sm:py-3 border shadow-sm rounded-xl focus:outline-none focus:ring-none duration-200 h-[5vh] sm:h-[6.3vh] text-sm sm:text-base ${theme === 'dark'
