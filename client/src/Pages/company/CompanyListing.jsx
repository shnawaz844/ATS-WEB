          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <div className="relative w-full sm:flex-grow">
              ...
              <input
                ...
                className="w-full sm:w-[30vw] pl-10 pr-4 py-2 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
              />
              {isSearching && (
                <button
                  onClick={clearSearch}
            ...
            <button
              ...
              className="flex items-center justify-center w-full sm:w-auto px-4 py-2 bg-gray-700 text-white rounded-xl hover:bg-gray-600 hover:text-white border border-white transition-colors duration-200 whitespace-nowrap shadow-sm"
            >
              <Plus size={20} />
                        ...
                        <div>
                          ...
                          <div className="mt-1">
                            <label
                              ...
                              className={`cursor-pointer flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200 overflow-hidden ${
                                formData.image ? "h-auto min-h-32" : "h-32"
                              }`}
                            >
                              {formData.image ? (
