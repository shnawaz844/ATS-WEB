        ...
        <div className="max-w-screen-xl mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 w-full">
                    <button className="bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-4 sm:px-8 rounded-lg font-medium transition-all duration-300 shadow-lg shadow-indigo-600/30 w-full sm:w-auto">
                        Get Started for Free
                    </button>
                    <button className="bg-white/10 hover:bg-white/20 text-white py-3 px-4 sm:px-8 rounded-lg font-medium backdrop-blur-sm transition-all duration-300 w-full sm:w-auto">
                        Schedule a Demo
                    </button>
                </div>
            </div>
