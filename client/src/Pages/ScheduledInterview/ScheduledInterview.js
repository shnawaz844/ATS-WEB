                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full gap-3 sm:gap-4">
                    ...
                    <div className="flex items-center w-full md:w-auto">
                        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white flex items-center">
                            <Briefcase className="mr-2 h-5 w-5 md:h-6 md:w-6 text-gray-100" />
                            ...
                            <div className="w-36 sm:w-auto bg-transparent rounded-xl flex items-center justify-center">
                                <div className="w-full sm:min-w-[200px]">
                                    <select
                                        ...
                                        className="w-full border border-gray-300 rounded-xl shadow-sm py-2 px-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700 hover:border-gray-400 transition-colors h-[40px] sm:h-auto"
                                    >
                        ...
                        <div className="w-full sm:w-[30vw]">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 sm:pl-10 pr-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 h-[40px] sm:h-auto"
                                />
                            </div>
                        </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-700">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Meet Link</th>
                        ...
                        <tbody className="divide-y divide-gray-200">
                            { assignedInterviews?.interviews?.map( ( interview ) => (
                                <tr key={ interview?._id } className="group hover:bg-gray-700 ">
                                    <td className="px-6 py-4 text-sm text-gray-900 group-hover:text-white whitespace-normal break-words">
                                        { capitalizeFirstLetter( interview?.applicationID?.jobID?.title ) || "N/A" }
                                    </td>
                                    <td className="px-6 py-4 text-sm text-gray-900 group-hover:text-white whitespace-normal break-words max-w-xs">
                                    ...
                                    <td className="px-6 py-4 text-sm whitespace-normal break-words max-w-xs">
                                        { interview?.applicationID?.resume ? (
                                            <button
                                                ...
                                                className="text-blue-600 hover:text-blue-900 group-hover:text-white font-medium transition-colors duration-200 break-words"
                                            >
                                                Open Resume
                                            </button>
                                        ) : (
                                    ...
                                    <td className="px-6 py-4 text-sm whitespace-normal break-words max-w-xs">
                                        { interview?.meetingLink ? (
                                            <a
                                                ...
                                                className="text-blue-600 hover:text-blue-900 group-hover:text-white font-medium transition-colors duration-200 underline break-words"
                                            >
                                                Join Meeting
                                            </a>
                                        ) : (
                                            <span className="text-gray-500 group-hover:text-gray-300">Walk In</span>
                                        ) }
                                    </td>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <select
                                                ...
                                                className="block w-full border border-gray-300 rounded-lg shadow-sm py-2 sm:py-3 pl-8 sm:pl-10 pr-8 sm:pr-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white text-sm sm:text-base"
                                            >
