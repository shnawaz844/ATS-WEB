      ...
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className='mb-6 min-h-[80px] sm:h-[15vh] flex flex-col sm:flex-row items-center justify-between rounded-xl p-4 bg-gray-700 gap-4'>
          <div className="flex items-center w-full sm:w-auto">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-white ml-3">Application Statuses</h1>
          </div>
          ...
          <>
            {applicationStatuses.length === 0 ? (
              <div className="h-64 flex flex-col items-center justify-center text-gray-500 px-4 text-center">
                ...
                <p className="text-sm sm:text-base">No application statuses found. Try adding a new one.</p>
              </div>
            ) : (
                    ...
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      <div className="flex items-center gap-2">
                        <div className="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600">
                          <span className="font-bold text-sm sm:text-base">{application.applicationStep}</span>
                        </div>
                        <h3 className="font-semibold text-gray-800 text-sm sm:text-base">Step {application.applicationStep}</h3>
                      </div>
                      <button
