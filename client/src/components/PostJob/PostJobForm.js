            ...
            >
                ...
                <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
                  ...
                  >
                    ...
                    >
                      ...
                      <option value="future" disabled>More modes coming soon...</option>
                    </select>
                  </FormField>
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="px-6 sm:px-8 py-2 sm:py-3 bg-[#9333ea] text-white font-medium hover:bg-[#9333ea] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#9333ea] focus:ring-offset-2 transition-colors text-sm sm:text-base flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed min-w-[160px]"
                >
                  {isLoading ? (
                    <>
