...
export default function Stats({ stats, jobStatuses = [], jobs = [] }) {
  ...
  const statsConfig = [
    {
      ...
      borderColor: theme === "dark" ? "border-blue-500/20" : "border-blue-100"
    },
    {
      ...
      borderColor: theme === "dark" ? "border-green-500/20" : "border-green-100"
    },
    {
    ...
    },
    {
      ...
      color: theme === "dark" ? "bg-purple-500/10" : "bg-purple-50",
      textColor: theme === "dark" ? "text-purple-400" : "text-purple-600",
      borderColor: theme === "dark" ? "border-purple-500/20" : "border-purple-100"
    },
    {
      label: "Offers Extended",
      value: actualStats.offersExtended.toLocaleString(),
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
        </svg>
      ),
      color: theme === "dark" ? "bg-orange-500/10" : "bg-orange-50",
      textColor: theme === "dark" ? "text-orange-400" : "text-orange-600",
      borderColor: theme === "dark" ? "border-orange-500/20" : "border-orange-100"
    }
  ];
