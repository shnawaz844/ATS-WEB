    ...
    <div className="max-w-4xl w-full px-4 mx-auto flex flex-col items-center ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 gap-y-6 w-full">
        ...
        <div className="md:col-span-2 space-y-6">
          {/* Job Overview */}
          <section className="bg-slate-50 rounded-xl border p-4 sm:p-6 space-y-4">
          ...
          {/* Location Details */}
          <section className="bg-slate-50 rounded-xl border p-4 sm:p-6">
          ...
          <section className="bg-slate-50 rounded-xl border p-4 sm:p-6">
            ...
            <div className="prose max-w-full text-sm" dangerouslySetInnerHTML={{ __html: description || 'No description available.' }} />
          </section>
        </div>
