...
const AllInterviews = () => {
  ...
  const renderRatingFilter = () => (
    <div className="relative w-full">
      ...
      <select
        className="w-[32vw] sm:w-auto appearance-none bg-gray-200 rounded-xl py-1.5 pl-4 pr-8 md:pr-10 focus:outline-none focus:ring-none hover:bg-white h-[5vh] md:h-auto border"
        value={ ratingFilter }
